...
public class Step extends Module {
    ...
    public boolean setup() {
       ...
       // autoDisable = registerBoolean("DisableOffGround", "autoDisable", true);
        height = registerDouble("Height", "stepHeight", 2.5, 0.5, 2.5);
        timer = registerBoolean("Timer", "stepTimer", false);
        reverse = registerBoolean("Reverse", "stepRev", false);
        mode = registerMode("Modes", "stepMode", modes, "Normal");
    ...
    public int onUpdate() {
       ...
       /* if (autoDisable.getValue() && !mc.player.onGround) {
            return;
        }*/
        ...
        if (mode.getValue().equalsIgnoreCase("Normal")) {
            ...
            double[] dir = MovementUtils.forward(0.1);
