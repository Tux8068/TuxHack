...
public class EntityUtil {
    ...
    //Why didnt they put isinhole in here reeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
    ...
    public static boolean basicChecksEntity(Entity pl) {
        return pl.getName().equals(mc.player.getName()) || TuxHack.getInstance().friends.isFriend(pl.getName()) || pl.isDead;
    }
