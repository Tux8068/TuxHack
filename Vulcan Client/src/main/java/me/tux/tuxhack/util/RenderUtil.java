...
public class RenderUtil extends Tessellator {
    ...
    public static void drawWireframe(final AxisAlignedBB bb, final float width, float r, float g, float b, float a) {
        GlStateManager.enableBlend();
        GlStateManager.disableDepth();
        GlStateManager.disableLighting();
        GlStateManager.disableCull();
    ...
    public static void drawBoxBottom(BlockPos hole, int red, int green, int blue, int value) {
    }
}
