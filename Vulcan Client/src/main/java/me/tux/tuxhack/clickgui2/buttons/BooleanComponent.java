...
public class BooleanComponent extends Component
{
    ...
    public void renderComponent() {
        ...
        if (ModuleManager.isModuleEnabled("CustomFont")) {
            TuxHack.fontRenderer.drawStringWithShadow(this.op.getName(), this.parent.parent.getX() + this.centeredNameCoords, this.parent.parent.getY() + this.offset + 2, Renderer.getFontColor(true, 0).getRGB());
        }
        else {
