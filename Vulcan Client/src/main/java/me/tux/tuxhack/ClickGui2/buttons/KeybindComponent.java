...
//		FontUtils.drawStringWithShadow(Hud.customFont.getValue(), this.binding ? "Key..." : ("Key: " + ChatFormatting.GRAY + Keyboard.getKeyName(this.parent.mod.getBind())), (this.parent.parent.getX() + 2), (this.parent.parent.getY() + this.offset + 2), com.gamesense.client.clickgui.frame.Renderer.getFontColor());
		...
		if (ModuleManager.isModuleEnabled("CUstomFont")) TuxHack.fontRenderer.drawStringWithShadow( this.binding ? "Key..." : ("Key: " + ChatFormatting.GRAY + Keyboard.getKeyName(this.parent.mod.getBind())), (this.parent.parent.getX() + this.centeredNameCoords), (this.parent.parent.getY() + this.offset + 2), Renderer.getFontColor(true, 0).getRGB());
