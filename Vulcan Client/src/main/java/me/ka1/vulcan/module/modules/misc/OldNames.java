...
public class OldNames extends Module {
    ...
    protected void onEnable() {
        ...
        try {
            ...
            new Thread(()-> {
                try {
                    sendLog("Running batch oldnames lookup, I will tell you when I am done.");
                    ...
                    for (EntityPlayer player : players) {
                        ...
                        oldNames += "\n" + (count % 3 == 0 ? "\f" : "");
                        mc.player.sendMessage(new TextComponentString("Done lookup for player " + player.getDisplayName().getUnformattedText()));
                        count++;
                    }
