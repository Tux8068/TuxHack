...
import static me.ka1.vulcan.util.BlockInteractionHelper.*;
...
public class SelfTrap extends Module {
    ...
    public void setup() {
        ...
        FULL = registerBoolean("FULL", "full", false);
        Cheap = registerBoolean("cheap", "cheap", false);
    ...
    @Override
    public int onUpdate() {
        if (sneak.getValue() && !mc.gameSettings.keyBindSneak.isKeyDown())
