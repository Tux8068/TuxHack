...
import me.ka1.vulcan.module.modules.client.Zormios;
...
public class Frames {
    public ArrayList<me.ka1.vulcan.ClickGui2.frame.Component> guicomponents;
    ...
    public Frames(final Module.Category catg){
        this.guicomponents = new ArrayList<me.ka1.vulcan.ClickGui2.frame.Component>();
        this.category = catg;
        this.open = true;
    ...
    public ArrayList<me.ka1.vulcan.ClickGui2.frame.Component> getComponents() {
    ...
    public void renderGUIFrame(final FontRenderer fontRenderer){
        ...
        if(ModuleManager.isModuleEnabled("CustomFont") == true) Vulcan.fontRenderer.drawStringWithShadow(this.category.name(), (float)(this.x + 2), (float)(this.y + 3), ClickGuiModule.color);
        else
        ...
        if (this.open && !this.guicomponents.isEmpty()){
            for (final me.ka1.vulcan.ClickGui2.frame.Component component : this.guicomponents){
        ...
        rainbowOffset = Zormios.getXormiosOffset();
        mc.renderEngine.bindTexture(new ResourceLocation("minecraft:zormios.png"));
        Renderer.renderImage(this.x - 1, this.y - 1, this.x + 1, this.y + this.rainbowOffset, this.width + 1, this.barHeight, 1920f, 1080f);
        GlStateManager.pushMatrix();
        Renderer.RenderBoxOutline(3,this.x - 1, this.y - 1, this.x + this.width, this.y + this.barHeight - 1, new Color(0, 0, 0)); // custom outline colour soon?!?!?!
        this.nameWidth = FontUtils.getStringWidth(false, this.category.name());
    ...
    public int getXormiosOffset(){
        return XormiosOffset;
    }
