            ...
            case 0: // ow
                ...
                if (nether.getValue()) {
                    if (mc.player.posY == 69 && nice.getValue()) {
                        Vulcan.fontRenderer.drawStringWithShadow("[" + x + "  " + "nice" + "  " + z + "]" + "  " + "[" + netherX + "  " + netherZ + "]", X.getValue(), Y.getValue(), new Color(r.getValue(), g.getValue(), b.getValue(), 255).getRGB());
                    } else
                        Vulcan.fontRenderer.drawStringWithShadow("[" + x + "  " + y + "  " + z + "]" + "  " + "[" + netherX + "  " + netherZ + "]", X.getValue(), Y.getValue(), new Color(r.getValue(), g.getValue(), b.getValue(), 255).getRGB());
                } else
                    Vulcan.fontRenderer.drawStringWithShadow("[" + x + "  " + y + "  " + z + "]", X.getValue(), Y.getValue(), new Color(r.getValue(), g.getValue(), b.getValue(), 255).getRGB());
                break;
            case -1: // nether

                if (mc.player.posY == 69 && nice.getValue()) {
                    Vulcan.fontRenderer.drawStringWithShadow("[" + x + "  " + "nice" + "  " + z + "]" + "  " + "[" + owX + "  " + owZ + "]", X.getValue(), Y.getValue(), new Color(r.getValue(), g.getValue(), b.getValue(), 255).getRGB());
                } else {
                    Vulcan.fontRenderer.drawStringWithShadow("[" + x + "  " + y + "  " + z + "]" + "  " + "[" + owX + "  " + owZ + "]", X.getValue(), Y.getValue(), new Color(r.getValue(), g.getValue(), b.getValue(), 255).getRGB());
                }
                break;
            case 1: // end
                if (mc.player.posY == 69 && nice.getValue()) {
                    Vulcan.fontRenderer.drawStringWithShadow("[" + x + "  " + "nice" + "  " + z + "]", X.getValue(), Y.getValue(), new Color(r.getValue(), g.getValue(), b.getValue(), 255).getRGB());
                } else {
                    Vulcan.fontRenderer.drawStringWithShadow("[" + x + "  " + y + "  " + z + "]", X.getValue(), Y.getValue(), new Color(r.getValue(), g.getValue(), b.getValue(), 255).getRGB());
                }
                default:
